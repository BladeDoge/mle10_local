...
with st.sidebar:
    ...
    models = ["Linear Model", "DNN","DNN_Reloaded","DNN w/ ELU","DNN w/ Leaky ReLU","DNN w/ Leaky ReLU and L2 Regularizer","TPOT"]
...
with tab2:    
    #  only one evaluation metric for this regression problem Mean Absolute Error
